...
public class PlayerStats_Singleton : Singleton<PlayerStats_Singleton>
{
    ...
    UI_HealthBar_Singleton uI_HealthBar_Singleton;
    private void Start()
    {
        uI_HealthBar_Singleton = UI_HealthBar_Singleton.Instance;
    ...
    {
        Debug.Log("fnc_changeHealth Called");
        playerCurrentHealth += valueChange;
        if (playerCurrentHealth > maxHealth) 
            playerCurrentHealth = maxHealth;

        if(uI_HealthBar_Singleton)
            uI_HealthBar_Singleton.fn_SetValue(playerCurrentHealth/ maxHealth, true);
