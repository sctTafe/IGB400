...
namespace Scott.Barley.v2
{
    ...
    public class DestructibleBuilding_ObjectPooling : MonoBehaviour {


        [System.Serializable]
        public class DestructibleBuilding_ProPool
        {
        ...
        public static DestructibleBuilding_ObjectPooling Instance;
        private void Awake()
        {
            Instance = this;
        }
        ...
        public List<DestructibleBuilding_ProPool> pools_List;
        ...
        void Start()
        {
            ...
            foreach (DestructibleBuilding_ProPool pool_current in pools_List)
            {
        ...
        /// <returns></returns>
        public GameObject DequeueFromPool(string tag, Vector3 position, Quaternion rotation)
        {
